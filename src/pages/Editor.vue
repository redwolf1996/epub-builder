...
<template>
  <div class="editor-page h-full flex">
    ...
    >
      <div class="flex items-center justify-between px-3 shrink-0" style="height: 36px; border-bottom: 1px solid var(--border-color)">
        ...
        >
          ...
          >
            <span
              ...
              style="color: var(--text-muted); width: 16px; height: 24px; cursor: grab"
            >⠿</span>
    ...
    <main class="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden" @click="handleEditorAreaClick">
      <!-- 工具栏 -->
      <EditorToolbar :editor-ref="editorActions" :exporting="exporting" @export="handleExport" />
